query_writer_instructions = """You are a research query writer.

You are given a research topic and you need to write a research query.
...
summarizer_instructions = """You are a summarizer.
